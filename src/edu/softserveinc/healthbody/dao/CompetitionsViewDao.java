...
public class CompetitionsViewDao extends AbstractDaoRead<CompetitionsView> {
	...
	public List<CompetitionsView> getActiveCompetitionsView() throws QueryNotFoundException, JDBCDriverException, DataBaseReadingException, EmptyResultSetException, CloseStatementException {
